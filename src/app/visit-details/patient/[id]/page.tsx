...
interface VisitDetails {
    ...
    prescriptions: string[] // Array de prescrições
}
            ...
            <div style={{ minHeight: "100vh", backgroundColor: "#f8fafc" }}>
                ...
                <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "2rem 1rem", textAlign: "center" }}>
                    ...
                    <p style={{ color: "#6b7280", marginBottom: "1.5rem" }}>
                        Verifique o ID da visita ou tente novamente mais tarde.
                    </p>
        ...
        <div style={{ minHeight: "100vh", backgroundColor: "#f8fafc" }}>
            ...
            <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "2rem 1rem" }}>
                        ...
                        <CardContent style={{ display: "grid", gap: "1.25rem", padding: "1.5rem" }}>
                            ...
                            <div>
                                <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", marginBottom: "0.5rem" }}>
                                    ...
                                    <span
                                        style={{ fontSize: "0.875rem", fontWeight: "600", color: "#6b7280", textTransform: "uppercase" }}
                                    >
                                        Data e Hora
                                    </span>
                                </div>
                            ...
                            <Separator />
                            <div>
                                <span style={{ fontSize: "0.875rem", fontWeight: "600", color: "#6b7280", textTransform: "uppercase" }}>
                                    Motivo
                                </span>
                            ...
                            {visit.cancel_reason /* Mostra motivo do cancelamento se existir */ && (
                                <>
                                    ...
                                    >
                                        <span
                                            style={{ fontSize: "0.875rem", fontWeight: "600", color: "#dc2626", textTransform: "uppercase" }}
                                        >
                    ...
                    <Card style={{ boxShadow: "0 4px 6px rgba(0, 0, 0, 0.07)", border: "1px solid #e5e7eb" }}>
                        ...
                        <CardContent style={{ padding: "1.5rem" }}>
                            ...
                            >
                                <img
                                    ...
                                    onError={(e) => {
                                        ...
                                        e.currentTarget.src = "/nurse-placeholder.jpg"
                                    }} // Melhor fallback
                                />
                                <div style={{ flex: 1 }}>
                            ...
                            <div style={{ display: "flex", gap: "0.75rem", marginBottom: "1.5rem", flexWrap: "wrap" }}>
                                <Button
                                    onClick={() => router.push(`/nurse-profile/${nurse.id}`)}
                                    style={{ backgroundColor: "#15803d", color: "white", flex: 1, minWidth: "150px", fontWeight: "600" }}
                                >
                                    <User className="h-4 w-4 mr-2" />
                                    Ver Perfil
                                </Button>
                                <Button
                                    onClick={() => router.push(`/chat/${nurse.id}`)}
                                    variant="outline"
                                    style={{ flex: 1, minWidth: "150px", fontWeight: "600", borderColor: "#15803d", color: "#15803d" }}
                                >
                ...
                {visit.prescriptions && visit.prescriptions.length > 0 && (
                    <Card
                        style={{ marginBottom: "1.5rem", boxShadow: "0 4px 6px rgba(0, 0, 0, 0.07)", border: "1px solid #e5e7eb" }}
                    >
                        <CardHeader style={{ backgroundColor: "#f9fafb", borderBottom: "1px solid #e5e7eb" }}>
                            <CardTitle style={{ display: "flex", alignItems: "center", gap: "0.5rem", color: "#1f2937" }}>
                                <Pill className="h-5 w-5" style={{ color: "#15803d" }} /> Prescrições
                            </CardTitle>
                        </CardHeader>
                        <CardContent style={{ padding: "1.5rem" }}>
                            <p style={{ color: "#6b7280", marginBottom: "1rem", fontSize: "0.875rem" }}>
                                Prescrições recomendadas pelo(a) enfermeiro(a) durante o atendimento:
                            </p>
                            <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
                                {visit.prescriptions.map((prescription, index) => (
                                    ...
                                    >
                                        ...
                                        <p style={{ color: "#1f2937", fontSize: "1rem", flex: 1 }}>{prescription}</p>
                                    </div>
                                ))}
                            </div>
                        </CardContent>
                        ...
                        <CardContent style={{ padding: "2rem" }}>
                            ...
                            >
                                <div style={{ textAlign: "center" }}>
                                    ...
                                    <p style={{ fontSize: "0.875rem", color: "#6b7280", marginTop: "1rem", fontWeight: "500" }}>
                                    ...
                                    <AlertDialogContent>
                                        <AlertDialogHeader>
                                            ...
                                            <AlertDialogDescription style={{ lineHeight: "1.7", fontSize: "1rem" }}>
                                                Você está prestes a enviar um alerta de emergência...
                                                <br />
                                                <br />
                                                <strong style={{ color: "#dc2626" }}>Use apenas em situações reais de emergência.</strong>
                                                <br />
                                                <br />
                                                Deseja continuar?
                                            </AlertDialogDescription>
