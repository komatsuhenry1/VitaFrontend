...
export default function VisitDetailsPage() {
    ...
    const getVisitTypeLabel = (type: string | undefined) => {
        ...
        try {
            ...
            const response = await fetch(`${API_BASE_URL}/emergency/alert`, {
                ...
                body: JSON.stringify({
                    ...
                    location: {
                        address: patient
                            ? `${patient.street}, ${patient.number}, ${patient.neighborhood}, ${patient.city} - ${patient.uf}`
            ...
            <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "2rem 1rem" }}>
                        ...
                        <CardContent style={{ padding: "1.5rem" }}>
                            ...
                            <div style={{ display: "flex", gap: "0.75rem", marginBottom: "1.5rem" }}>
                                <Button
                                    ...
                                    style={{ flex: 1, backgroundColor: "#15803d", color: "white", fontWeight: "600" }}
                                >
                                ...
                                <Button
                                    ...
                                    variant="outline"
                                    style={{ flex: 1, fontWeight: "600", borderColor: "#15803d", color: "#15803d" }}
                                >
                ...
                >
                    <p style={{ marginBottom: "0.25rem" }}>
                        Criado em: <span style={{ fontWeight: "600", color: "#1f2937" }}>{visit.created_at}</span>
                    </p>
                    <p>
                        Última atualização: <span style={{ fontWeight: "600", color: "#1f2937" }}>{visit.updated_at}</span>
                    </p>
                </div>
            </div>
            <Footer />
